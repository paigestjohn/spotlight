...
- It reads `{CASE_DIR}/data/findings.json` — the investigator's structured output
  ...
  "evidence_for": [
    {
      ...
      "local_file": "{CASE_ROOT}/example/research/sam-gov-abc123.md"
    },
    {
...
- The fact-checker works from the investigator's pre-scraped `{CASE_DIR}/research/`
